<div class="rs-team-grid rs-team team-grid-<?php echo esc_html($settings['team_grid_style']); ?> <?php echo esc_html($settings['team_grid_popup']);?> rsaddon_pro_box">
	<div class="row">
		 	<?php //******************//
							...
							<div class="image-wrap">
								...
								<?php } else { ?>
									<?php if($settings['team_grid_popup']=='popup'): ?>
								  		<a class="pointer-events" href="#rs_popupBox5_<?php echo esc_attr($unique);?>" data-effect="mfp-zoom-in">
								    <?php else: ?>
				...
				<div id="rs_popupBox5_<?php echo esc_attr($unique);?>" class="rspopup_style1   mfp-with-anim mfp-hide" <?php echo wp_kses_post($popup_background);?>>
					<div class="row">
						<div class="col-md-5">
