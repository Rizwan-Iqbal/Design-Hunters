<div class="rs-team-grid rs-team team-grid-<?php echo esc_html($settings['team_grid_style']); ?> <?php echo esc_html($settings['team_grid_popup']);?> rsaddon_pro_box">
	<div class="row">
		 	<?php //******************//
				...
				?>					
					<div class="col-lg-<?php echo esc_html($settings['team_columns']);?> col-md-6 col-xs-1 team-style5">
						<div class="team-item">
									...
									<?php if('none_style' == $settings['team_grid_popup']){ ?>
										...
										<?php if(has_post_thumbnail()) : ?>
									    	<?php if($settings['team_grid_popup']=='popup'): ?>
										  		<a class="pointer-events" href="#rs_popupBox4_<?php echo esc_attr($unique);?>" data-effect="mfp-zoom-in">
										    <?php else: ?>
